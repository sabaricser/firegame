...
# surface is already initialized below, but we'll use a better name for clarity if needed.
# For now, let's stick to the user's variables but redirect drawing.
...
async def main():
    global score, hi_score, player_life, bullet_counter, paused, running, is_shooting, last_shot_time, screen_shake, bg_y_shift, current_image, background_top, new_background_activated
    ...
    while running:
        ...
        if not paused:
            ...
            for star in stars:
                ...
                pygame.draw.circle(screen, (200, 200, 200), star['pos'], star['size'])
        ...
        for meteor_object in meteor_group:
            ...
            if meteor_object.rect.colliderect(player.rect):
                ...
                score += 50
                screen_shake = 10
                particle_system.create_burst(meteor_object.rect.center, (255, 100, 0), count=15)
            ...
            for bullet_collision in bullet_collisions:
                ...
                meteor_object.kill()
                score += 80
                particle_system.create_burst(meteor_object.rect.center, (200, 200, 200), count=10)
        ...
        for enemy_object in enemy1_group:
            ...
            if enemy_object.rect.colliderect(player.rect):
                ...
                score += 20
                screen_shake = 12
                particle_system.create_burst(enemy_object.rect.center, (255, 0, 0), count=20)
            ...
            for bullet_collision in bullet_collisions:
                ...
                enemy_object.kill()
                score += 50
                particle_system.create_burst(enemy_object.rect.center, (255, 200, 100), count=12)
        ...
        for boss1_object in boss1_group:
            ...
            for bullet_collision in bullet_collisions:
                ...
                explosions2.add(explosion2)
                boss1_health -= 5
                particle_system.create_burst(boss1_object.rect.center, (255, 255, 100), count=5)
                if boss1_health <= 0:
                    ...
                    score += 400
                    screen_shake = 30
                    particle_system.create_burst(boss1_object.rect.center, (255, 150, 0), count=50, speed_range=(2, 10), duration=1000)
        ...
        for boss2_object in boss2_group:
            ...
            for bullet_collision in bullet_collisions:
                ...
                explosions2.add(explosion2)
                boss2_health -= 8
                particle_system.create_burst(boss2_object.rect.center, (100, 255, 100), count=5)
                if boss2_health <= 0:
                    ...
                    score += 800
                    screen_shake = 40
                    particle_system.create_burst(boss2_object.rect.center, (0, 255, 100), count=60, speed_range=(2, 12), duration=1200)
        ...
        for boss3_object in boss3_group:
            ...
            for bullet_collision in bullet_collisions:
                ...
                explosions2.add(explosion2)
                boss3_health -= 6
                particle_system.create_burst(boss3_object.rect.center, (100, 100, 255), count=5)
                if boss3_health <= 0:
                    ...
                    score += 1000
                    screen_shake = 50
                    particle_system.create_burst(boss3_object.rect.center, (100, 0, 255), count=100, speed_range=(2, 15), duration=1500)
                    # Extra particles for boss 3 final death
                    particle_system.create_burst(boss3_object.rect.center, (255, 255, 255), count=30, speed_range=(1, 5), duration=2000)
        ...
        # Engine Trail
        if not paused:
            trail_pos = (player.rect.centerx, player.rect.bottom - 10)
            particle_system.create_burst(trail_pos, (100, 200, 255), count=2, speed_range=(0.5, 2), duration=300)
        ...
        for bullet in bullets:
            bullet.update()
            # Draw Glow
            glow_rect = bullet.glow.get_rect(center=bullet.rect.center)
            screen.blit(bullet.glow, glow_rect)
        ...
        # Normally we would blit everything to a surface and then blit that surface with the offset.
        # But since we are blitting directly to the screen throughout the loop, 
        # we'll just apply it to the final flip or wait for a better refactor.
        # For now, let's at least handle the particle bursts on collisions.
        ...
        screen.blit(hi_score_surface, (hi_score_x_pos, 50))

        pygame.display.flip()
        clock.tick(FPS)
        await asyncio.sleep(0) # Required for web (pygbag)
